...
const ADDITIONAL_SERVICES = [
  ...
  },
  {
    ...
    description:
      "Comprehensive treatment targeting scalp health and loc nourishment for optimal hair wellness.",
    duration: "45-60 mins",
    priceRange: "From £45",
    image: "/services/scalp-and-loc-care.jpeg",
    icon: Heart,
  ...
  },
  {
    ...
    description:
      "Professional wash and conditioning service to keep your locs clean, fresh, and healthy.",
    duration: "30-45 mins",
    priceRange: "From £30",
    image: "/services/wash.jpeg",
    icon: Droplets,
  ...
  },
  {
    ...
    description:
      "A lightweight moisture infusion designed to revive dry scalp and dull locs without leaving residue.",
    duration: "10 mins",
    priceRange: "£15",
    image: "/services/hydration-treatment.jpeg",
    icon: Wind,
  ...
  },
  {
    ...
    description:
      "A warming scalp ritual designed to nourish, soothe, and stimulate circulation.",
    duration: "45 mins",
    priceRange: "£45",
    image: "/services/hot-oil-treatment.jpg",
    icon: Flame,
  ...
  },
  {
    title: "Loc Detox",
    description:
      "Our signature deep purification service that gently lifts deep-seated buildup while protecting the integrity of your locs.",
    duration: "1 hr 30 mins",
    priceRange: "£65",
    image: "/services/loc-detox.jpg",
    icon: Droplets,
  ...
  },
  {
    ...
    description:
      "Professional and gentle removal of locs when you're ready for a change, without damaging your natural hair.",
    duration: "2-8 hours",
    priceRange: "From £150",
